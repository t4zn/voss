    ...
    <footer className="bg-gray-900 text-white py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
          {/* Brand */}
          <div>
            <div className="font-serif text-xl md:text-2xl mb-3 md:mb-4">VOSS</div>
          ...
          {/* Products */}
          <div>
            <h4 className="text-xs md:text-sm tracking-widest mb-3 md:mb-4 text-white/80">PRODUCTS</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-xs md:text-sm tracking-widest mb-3 md:mb-4 text-white/80">COMPANY</h4>
            <ul className="space-y-2 text-sm">
          ...
          {/* Follow */}
          <div>
            <h4 className="text-xs md:text-sm tracking-widest mb-3 md:mb-4 text-white/80">FOLLOW</h4>
            <ul className="space-y-2 text-sm">
        ...
        {/* Bottom Bar */}
        <div className="pt-6 md:pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-white/40">
